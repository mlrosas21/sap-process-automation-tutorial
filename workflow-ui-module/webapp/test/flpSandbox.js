		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ordersworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ordersworkflowuimodule-display": {
								"semanticObject": "ordersworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=orders.workflowuimodule",
									"url": sap.ui.require.toUrl("orders/workflowuimodule")
								}
							}
						}
					}
